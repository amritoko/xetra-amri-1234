...
class XetraSourceConfig(NamedTuple):
    ...
    src_col_start price: column name for starting price in source
...
class XetraETL():
    ...
    def __init__(self, s3_bucket_src: S3BucketConnector,
        ...
        :param src_args: NamedTupple class with source configuration data
        :param trg_args: NamedTupple class with target configuration data
        """
