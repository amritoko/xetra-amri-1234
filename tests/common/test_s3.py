...
class TestS3BukcetConnectorMethods(unittest.TestCase):
    """
    ...
    def test_list_files_in_prefix_ok(self):
        """
        Tests the list_files_in_prefix method for getting two file keys
    ...
    def test_list_files_in_prefix_wrong_prefix(self):
        ...
        self.s3_bucket.put_object(Body=csv_content, Key=key2_exp)
        # Method Execution
        list_result = self.s3_bucket_conn.list_files_in_prefix(prefix_wrong)
        # Tests after method execution
